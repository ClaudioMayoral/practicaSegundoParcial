...
exports.SuccessDelete = new MensajeUsuario("Success", "Deleted successfully", 200)


module.exports= {InvalidTypeException, InvalidTitleException, InvalidDescriptionException, InvalidContentException, Forbiden, SuccessCreate, SuccessUpdate}
